...
const  CurrentLocalMap =({location})=>{
    ...
    return (
            ...
            <WebView source={{ uri: `https://toxicgps.moenv.gov.tw/GPSwebU/GMap/TGosMapForApp.aspx?servicekey=V9achV7sd8AK&type=current&lon=${location.longitude}&lat=${location.latitude}` }} ClassName='flex-1' />
