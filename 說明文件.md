...
- 公司 WIFI:
  - RT_N18U_Pst
  - pstcom@123
- 公司 Mac-Mini 的密碼(下 sudo 指令時會要求的)：
  - 使用者: pst
  - 密碼: 888888
  - AnyDesk:
    - acct: 868 779 837
    - pw: pstcom@123
- Google Play Console - Google Play 上架入口
  - https://play.google.com/console/u/0/signup
  - 帳號： app@mail.pstcom.com.tw
  - 密碼： pst@2339#COM
- App Store Connect - Apple 上架入口
...
- Experience with id 'e1ddc640-2333-4337-80a0-f574b2ce9b84' does not exist.
- 去app.json把"extra": {
      "eas": {
